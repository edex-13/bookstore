async function getEditorials () {
  const response = await fetch('http://localhost/bookstore/authors/showData')
...
async function crateEditorial () {
  ...
  const response = await fetch(`http://localhost/bookstore/authors/create/`, {
    method: 'POST',
    body: data 
  })
  await response.json()
...
async function updateEditorial (id) {
  ...
  const response = await fetch(`http://localhost/bookstore/authors/update/`, {
    method: 'POST',
    body: data
  })
  await response.json()
...
async function deleteEditorial (id) {
  ...
  data.append('id', id);
  const response = await fetch(`http://localhost/bookstore/authors/delete/`, {
    method: 'POST',
    body: data
  })
  await response.json()
